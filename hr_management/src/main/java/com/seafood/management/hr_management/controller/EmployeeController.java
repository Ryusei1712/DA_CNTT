...
import com.seafood.management.hr_management.dto.EmployeeDTO;
import com.seafood.management.hr_management.model.Employee;
import com.seafood.management.hr_management.service.EmployeeService;
...
public class EmployeeController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<String> deleteEmployeeByCode(@PathVariable String id) {
        boolean deleted = employeeService.deleteEmployeeByCode(id);
